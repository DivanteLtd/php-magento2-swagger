[![Build Status](https://travis-ci.org/DivanteLtd/php-magento2-swagger.svg?branch=master)](https://travis-ci.org/DivanteLtd/php-magento2-swagger)

# PHP Magento2 API Client
Magento 2 REST API client automatically generated by Swagger Codegen https://github.com/swagger-api/swagger-codegen)
...
```
{
  "repositories": [
    {
      "type": "git",
      "url": "https://github.com/DivanteLtd/php-magento2-swagger.git"
    }
  ],
  "require": {
    "divanteltd/php-magento2-swagger": "*@dev"
  }
}
```
