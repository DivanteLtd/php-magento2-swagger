# Swagger\Magento2Client\SalesOrderManagementV1Api
...
$api_instance = new Swagger\Magento2Client\Api\SalesOrderManagementV1Api();
$id = 56; // int | The order ID.
$body = new \Swagger\Magento2Client\Model\body_65(); // \Swagger\Magento2Client\Model\Body65 | 
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| The order ID. |
 **body** | [**\Swagger\Magento2Client\Model\Body65**](../Model/body_65.md)|  | [optional]
...
> \Swagger\Magento2Client\Model\SalesDataOrderStatusHistorySearchResultInterface salesOrderManagementV1GetCommentsListGet($id)
...
[**\Swagger\Magento2Client\Model\SalesDataOrderStatusHistorySearchResultInterface**](../Model/SalesDataOrderStatusHistorySearchResultInterface.md)
