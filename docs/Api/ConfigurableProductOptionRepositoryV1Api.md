# Swagger\Magento2Client\ConfigurableProductOptionRepositoryV1Api
...
$api_instance = new Swagger\Magento2Client\Api\ConfigurableProductOptionRepositoryV1Api();
...
> \Swagger\Magento2Client\Model\ConfigurableProductDataOptionInterface configurableProductOptionRepositoryV1GetGet($sku, $id)
...
[**\Swagger\Magento2Client\Model\ConfigurableProductDataOptionInterface**](../Model/ConfigurableProductDataOptionInterface.md)
...
> \Swagger\Magento2Client\Model\ConfigurableProductDataOptionInterface[] configurableProductOptionRepositoryV1GetListGet($sku)
...
$api_instance = new Swagger\Magento2Client\Api\ConfigurableProductOptionRepositoryV1Api();
$sku = "sku_example"; // string | 
$body = new \Swagger\Magento2Client\Model\body_112(); // \Swagger\Magento2Client\Model\Body112 | 
...
------------- | ------------- | ------------- | -------------
 **sku** | **string**|  |
 **body** | [**\Swagger\Magento2Client\Model\Body112**](../Model/body_112.md)|  | [optional]
...
$body = new \Swagger\Magento2Client\Model\body_111(); // \Swagger\Magento2Client\Model\Body111 | 
 ...
 **sku** | **string**|  |
 **id** | **string**|  |
 **body** | [**\Swagger\Magento2Client\Model\Body111**](../Model/body_111.md)|  | [optional]
