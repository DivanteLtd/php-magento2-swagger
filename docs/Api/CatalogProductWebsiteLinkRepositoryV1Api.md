# Swagger\Magento2Client\CatalogProductWebsiteLinkRepositoryV1Api
...
$api_instance = new Swagger\Magento2Client\Api\CatalogProductWebsiteLinkRepositoryV1Api();
...
$api_instance = new Swagger\Magento2Client\Api\CatalogProductWebsiteLinkRepositoryV1Api();
$sku = "sku_example"; // string | 
$body = new \Swagger\Magento2Client\Model\body_40(); // \Swagger\Magento2Client\Model\Body40 | 
...
------------- | ------------- | ------------- | -------------
 **sku** | **string**|  |
 **body** | [**\Swagger\Magento2Client\Model\Body40**](../Model/body_40.md)|  | [optional]
...
$api_instance = new Swagger\Magento2Client\Api\CatalogProductWebsiteLinkRepositoryV1Api();
$sku = "sku_example"; // string | 
$body = new \Swagger\Magento2Client\Model\body_39(); // \Swagger\Magento2Client\Model\Body39 | 
...
------------- | ------------- | ------------- | -------------
 **sku** | **string**|  |
 **body** | [**\Swagger\Magento2Client\Model\Body39**](../Model/body_39.md)|  | [optional]
