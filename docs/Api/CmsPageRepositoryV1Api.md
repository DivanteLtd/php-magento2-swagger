# Swagger\Magento2Client\CmsPageRepositoryV1Api
...
$api_instance = new Swagger\Magento2Client\Api\CmsPageRepositoryV1Api();
$page_id = 56; // int | 
...
> \Swagger\Magento2Client\Model\CmsDataPageInterface cmsPageRepositoryV1GetByIdGet($page_id)
...
[**\Swagger\Magento2Client\Model\CmsDataPageInterface**](../Model/CmsDataPageInterface.md)
...
[**\Swagger\Magento2Client\Model\CmsDataPageSearchResultsInterface**](../Model/CmsDataPageSearchResultsInterface.md)
...
> \Swagger\Magento2Client\Model\CmsDataPageInterface cmsPageRepositoryV1SavePost($body)
...
$api_instance = new Swagger\Magento2Client\Api\CmsPageRepositoryV1Api();
$body = new \Swagger\Magento2Client\Model\body_14(); // \Swagger\Magento2Client\Model\Body14 | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Magento2Client\Model\Body14**](../Model/body_14.md)|  | [optional]
...
> \Swagger\Magento2Client\Model\CmsDataPageInterface cmsPageRepositoryV1SavePut($id, $body)
...
$body = new \Swagger\Magento2Client\Model\body_15(); // \Swagger\Magento2Client\Model\Body15 | 
...
------------- | ------------- | ------------- | -------------
 **id** | **string**|  |
 **body** | [**\Swagger\Magento2Client\Model\Body15**](../Model/body_15.md)|  | [optional]
