# Swagger\Magento2Client\DownloadableLinkRepositoryV1Api
...
$api_instance = new Swagger\Magento2Client\Api\DownloadableLinkRepositoryV1Api();
$id = 56; // int | 
...
> \Swagger\Magento2Client\Model\DownloadableDataLinkInterface[] downloadableLinkRepositoryV1GetListGet($sku)
...
[**\Swagger\Magento2Client\Model\DownloadableDataLinkInterface[]**](../Model/DownloadableDataLinkInterface.md)
...
$api_instance = new Swagger\Magento2Client\Api\DownloadableLinkRepositoryV1Api();
$sku = "sku_example"; // string | 
$body = new \Swagger\Magento2Client\Model\body_78(); // \Swagger\Magento2Client\Model\Body78 | 
...
------------- | ------------- | ------------- | -------------
 **sku** | **string**|  |
 **body** | [**\Swagger\Magento2Client\Model\Body78**](../Model/body_78.md)|  | [optional]
...
$body = new \Swagger\Magento2Client\Model\body_79(); // \Swagger\Magento2Client\Model\Body79 | 
 ...
 **sku** | **string**|  |
 **id** | **string**|  |
 **body** | [**\Swagger\Magento2Client\Model\Body79**](../Model/body_79.md)|  | [optional]
