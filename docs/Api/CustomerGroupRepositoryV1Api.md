# Swagger\Magento2Client\CustomerGroupRepositoryV1Api
...
$api_instance = new Swagger\Magento2Client\Api\CustomerGroupRepositoryV1Api();
$id = 56; // int | 
...
> \Swagger\Magento2Client\Model\CustomerDataGroupInterface customerGroupRepositoryV1GetByIdGet($id)
...
[**\Swagger\Magento2Client\Model\CustomerDataGroupSearchResultsInterface**](../Model/CustomerDataGroupSearchResultsInterface.md)
...
> \Swagger\Magento2Client\Model\CustomerDataGroupInterface customerGroupRepositoryV1SavePost($body)
...
$api_instance = new Swagger\Magento2Client\Api\CustomerGroupRepositoryV1Api();
$body = new \Swagger\Magento2Client\Model\body_3(); // \Swagger\Magento2Client\Model\Body3 | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Magento2Client\Model\Body3**](../Model/body_3.md)|  | [optional]
...
> \Swagger\Magento2Client\Model\CustomerDataGroupInterface customerGroupRepositoryV1SavePut($id, $body)
...
$body = new \Swagger\Magento2Client\Model\body_2(); // \Swagger\Magento2Client\Model\Body2 | 
...
------------- | ------------- | ------------- | -------------
 **id** | **string**|  |
 **body** | [**\Swagger\Magento2Client\Model\Body2**](../Model/body_2.md)|  | [optional]
