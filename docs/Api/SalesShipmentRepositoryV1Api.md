# Swagger\Magento2Client\SalesShipmentRepositoryV1Api
...
> \Swagger\Magento2Client\Model\SalesDataShipmentInterface salesShipmentRepositoryV1GetGet($id)
...
$api_instance = new Swagger\Magento2Client\Api\SalesShipmentRepositoryV1Api();
...
[**\Swagger\Magento2Client\Model\SalesDataShipmentInterface**](../Model/SalesDataShipmentInterface.md)
...
[**\Swagger\Magento2Client\Model\SalesDataShipmentSearchResultInterface**](../Model/SalesDataShipmentSearchResultInterface.md)
...
> \Swagger\Magento2Client\Model\SalesDataShipmentInterface salesShipmentRepositoryV1SavePost($body)
...
$api_instance = new Swagger\Magento2Client\Api\SalesShipmentRepositoryV1Api();
$body = new \Swagger\Magento2Client\Model\body_73(); // \Swagger\Magento2Client\Model\Body73 | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Magento2Client\Model\Body73**](../Model/body_73.md)|  | [optional]
