# Swagger\Magento2Client\RmaRmaManagementV1Api
...
> \Swagger\Magento2Client\Model\RmaDataRmaInterface rmaRmaManagementV1SaveRmaPost($body)
...
$api_instance = new Swagger\Magento2Client\Api\RmaRmaManagementV1Api();
$body = new \Swagger\Magento2Client\Model\body_133(); // \Swagger\Magento2Client\Model\Body133 | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Magento2Client\Model\Body133**](../Model/body_133.md)|  | [optional]
...
> \Swagger\Magento2Client\Model\RmaDataRmaInterface rmaRmaManagementV1SaveRmaPut($id, $body)
...
$body = new \Swagger\Magento2Client\Model\body_130(); // \Swagger\Magento2Client\Model\Body130 | 
...
------------- | ------------- | ------------- | -------------
 **id** | **string**|  |
 **body** | [**\Swagger\Magento2Client\Model\Body130**](../Model/body_130.md)|  | [optional]
...
[**\Swagger\Magento2Client\Model\RmaDataRmaSearchResultInterface**](../Model/RmaDataRmaSearchResultInterface.md)
