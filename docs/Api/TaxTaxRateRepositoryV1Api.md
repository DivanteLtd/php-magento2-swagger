# Swagger\Magento2Client\TaxTaxRateRepositoryV1Api
...
$api_instance = new Swagger\Magento2Client\Api\TaxTaxRateRepositoryV1Api();
$rate_id = 56; // int | 
...
> \Swagger\Magento2Client\Model\TaxDataTaxRateInterface taxTaxRateRepositoryV1GetGet($rate_id)
...
[**\Swagger\Magento2Client\Model\TaxDataTaxRateInterface**](../Model/TaxDataTaxRateInterface.md)
...
[**\Swagger\Magento2Client\Model\TaxDataTaxRateSearchResultsInterface**](../Model/TaxDataTaxRateSearchResultsInterface.md)
...
> \Swagger\Magento2Client\Model\TaxDataTaxRateInterface taxTaxRateRepositoryV1SavePost($body)
...
$api_instance = new Swagger\Magento2Client\Api\TaxTaxRateRepositoryV1Api();
$body = new \Swagger\Magento2Client\Model\body_94(); // \Swagger\Magento2Client\Model\Body94 | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Magento2Client\Model\Body94**](../Model/body_94.md)|  | [optional]
...
> \Swagger\Magento2Client\Model\TaxDataTaxRateInterface taxTaxRateRepositoryV1SavePut($body)
...
$api_instance = new Swagger\Magento2Client\Api\TaxTaxRateRepositoryV1Api();
$body = new \Swagger\Magento2Client\Model\body_93(); // \Swagger\Magento2Client\Model\Body93 | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Magento2Client\Model\Body93**](../Model/body_93.md)|  | [optional]
