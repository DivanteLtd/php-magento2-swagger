# Swagger\Magento2Client\TaxTaxClassRepositoryV1Api
...
$api_instance = new Swagger\Magento2Client\Api\TaxTaxClassRepositoryV1Api();
$tax_class_id = 56; // int | 
...
> \Swagger\Magento2Client\Model\TaxDataTaxClassInterface taxTaxClassRepositoryV1GetGet($tax_class_id)
...
[**\Swagger\Magento2Client\Model\TaxDataTaxClassInterface**](../Model/TaxDataTaxClassInterface.md)
...
[**\Swagger\Magento2Client\Model\TaxDataTaxClassSearchResultsInterface**](../Model/TaxDataTaxClassSearchResultsInterface.md)
...
$api_instance = new Swagger\Magento2Client\Api\TaxTaxClassRepositoryV1Api();
$body = new \Swagger\Magento2Client\Model\body_97(); // \Swagger\Magento2Client\Model\Body97 | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Magento2Client\Model\Body97**](../Model/body_97.md)|  | [optional]
...
$body = new \Swagger\Magento2Client\Model\body_98(); // \Swagger\Magento2Client\Model\Body98 | 
...
------------- | ------------- | ------------- | -------------
 **class_id** | **string**|  |
 **body** | [**\Swagger\Magento2Client\Model\Body98**](../Model/body_98.md)|  | [optional]
