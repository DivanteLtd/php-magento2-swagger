# Swagger\Magento2Client\TaxTaxRuleRepositoryV1Api
...
$api_instance = new Swagger\Magento2Client\Api\TaxTaxRuleRepositoryV1Api();
$rule_id = 56; // int | 
...
> \Swagger\Magento2Client\Model\TaxDataTaxRuleInterface taxTaxRuleRepositoryV1GetGet($rule_id)
...
[**\Swagger\Magento2Client\Model\TaxDataTaxRuleInterface**](../Model/TaxDataTaxRuleInterface.md)
...
[**\Swagger\Magento2Client\Model\TaxDataTaxRuleSearchResultsInterface**](../Model/TaxDataTaxRuleSearchResultsInterface.md)
...
> \Swagger\Magento2Client\Model\TaxDataTaxRuleInterface taxTaxRuleRepositoryV1SavePost($body)
...
$api_instance = new Swagger\Magento2Client\Api\TaxTaxRuleRepositoryV1Api();
$body = new \Swagger\Magento2Client\Model\body_96(); // \Swagger\Magento2Client\Model\Body96 | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Magento2Client\Model\Body96**](../Model/body_96.md)|  | [optional]
...
> \Swagger\Magento2Client\Model\TaxDataTaxRuleInterface taxTaxRuleRepositoryV1SavePut($body)
...
$api_instance = new Swagger\Magento2Client\Api\TaxTaxRuleRepositoryV1Api();
$body = new \Swagger\Magento2Client\Model\body_95(); // \Swagger\Magento2Client\Model\Body95 | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Magento2Client\Model\Body95**](../Model/body_95.md)|  | [optional]
