# Swagger\Magento2Client\CatalogProductAttributeManagementV1Api
...
$api_instance = new Swagger\Magento2Client\Api\CatalogProductAttributeManagementV1Api();
$body = new \Swagger\Magento2Client\Model\body_24(); // \Swagger\Magento2Client\Model\Body24 | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Magento2Client\Model\Body24**](../Model/body_24.md)|  | [optional]
...
> \Swagger\Magento2Client\Model\CatalogDataProductAttributeInterface[] catalogProductAttributeManagementV1GetAttributesGet($attribute_set_id)
