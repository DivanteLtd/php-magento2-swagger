# Swagger\Magento2Client\CatalogProductRepositoryV1Api
...
$api_instance = new Swagger\Magento2Client\Api\CatalogProductRepositoryV1Api();
...
> \Swagger\Magento2Client\Model\CatalogDataProductInterface catalogProductRepositoryV1GetGet($sku, $edit_mode, $store_id, $force_reload)
...
[**\Swagger\Magento2Client\Model\CatalogDataProductSearchResultsInterface**](../Model/CatalogDataProductSearchResultsInterface.md)
...
> \Swagger\Magento2Client\Model\CatalogDataProductInterface catalogProductRepositoryV1SavePost($body)
...
$api_instance = new Swagger\Magento2Client\Api\CatalogProductRepositoryV1Api();
$body = new \Swagger\Magento2Client\Model\body_18(); // \Swagger\Magento2Client\Model\Body18 | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Magento2Client\Model\Body18**](../Model/body_18.md)|  | [optional]
...
> \Swagger\Magento2Client\Model\CatalogDataProductInterface catalogProductRepositoryV1SavePut($sku, $body)
...
$api_instance = new Swagger\Magento2Client\Api\CatalogProductRepositoryV1Api();
$sku = "sku_example"; // string | 
$body = new \Swagger\Magento2Client\Model\body_19(); // \Swagger\Magento2Client\Model\Body19 | 
...
------------- | ------------- | ------------- | -------------
 **sku** | **string**|  |
 **body** | [**\Swagger\Magento2Client\Model\Body19**](../Model/body_19.md)|  | [optional]
