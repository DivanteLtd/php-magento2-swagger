# Swagger\Magento2Client\QuoteGuestCartManagementV1Api
...
$api_instance = new Swagger\Magento2Client\Api\QuoteGuestCartManagementV1Api();
$cart_id = "cart_id_example"; // string | The cart ID.
$body = new \Swagger\Magento2Client\Model\body_44(); // \Swagger\Magento2Client\Model\Body44 | 
 ...
 **body** | [**\Swagger\Magento2Client\Model\Body44**](../Model/body_44.md)|  | [optional]
...
$api_instance = new Swagger\Magento2Client\Api\QuoteGuestCartManagementV1Api();
$cart_id = "cart_id_example"; // string | The cart ID.
$body = new \Swagger\Magento2Client\Model\body_45(); // \Swagger\Magento2Client\Model\Body45 | 
...
------------- | ------------- | ------------- | -------------
 **cart_id** | **string**| The cart ID. |
 **body** | [**\Swagger\Magento2Client\Model\Body45**](../Model/body_45.md)|  | [optional]
