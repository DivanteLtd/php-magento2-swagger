...
class SalesRefundInvoiceV1Api
{
     ...
     * @param \Swagger\Magento2Client\Model\Body69 $body  (optional)
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return int
     */
    public function salesRefundInvoiceV1ExecutePost($invoice_id, $body = null)
    {
        list($response) = $this->salesRefundInvoiceV1ExecutePostWithHttpInfo($invoice_id, $body);
        return $response;
    }
     ...
     */
    public function salesRefundInvoiceV1ExecutePostWithHttpInfo($invoice_id, $body = null)
    {
        // verify the required parameter 'invoice_id' is set
        if ($invoice_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $invoice_id when calling salesRefundInvoiceV1ExecutePost');
        }
        // parse inputs
