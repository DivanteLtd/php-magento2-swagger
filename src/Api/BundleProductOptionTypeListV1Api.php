...
class BundleProductOptionTypeListV1Api
{
     ...
     * @return \Swagger\Magento2Client\Model\BundleDataOptionTypeInterface[]
     */
     ...
     *
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return array of \Swagger\Magento2Client\Model\BundleDataOptionTypeInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function bundleProductOptionTypeListV1GetItemsGetWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Magento2Client\Model\BundleDataOptionTypeInterface[]',
                '/V1/bundle-products/options/types'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Magento2Client\Model\BundleDataOptionTypeInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Magento2Client\Model\BundleDataOptionTypeInterface[]', $e->getResponseHeaders());
