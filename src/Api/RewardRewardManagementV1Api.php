...
/**
 * RewardRewardManagementV1Api Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Magento2Client
 * @author   Swagger Codegen team
...
class RewardRewardManagementV1Api
{
     ...
     *
     * @return RewardRewardManagementV1Api
     */
     ...
     * @return bool
     */
    public function rewardRewardManagementV1SetPost()
    {
        list($response) = $this->rewardRewardManagementV1SetPostWithHttpInfo();
        return $response;
    }

    /**
     * Operation rewardRewardManagementV1SetPostWithHttpInfo
     *
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return array of bool, HTTP status code, HTTP response headers (array of strings)
     */
    public function rewardRewardManagementV1SetPostWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/V1/reward/mine/use-reward";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
