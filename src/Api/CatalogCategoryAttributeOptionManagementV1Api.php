...
class CatalogCategoryAttributeOptionManagementV1Api
{
     ...
     */
    public function catalogCategoryAttributeOptionManagementV1GetItemsGet($attribute_code)
    {
        list($response) = $this->catalogCategoryAttributeOptionManagementV1GetItemsGetWithHttpInfo($attribute_code);
        return $response;
    }
     ...
     */
    public function catalogCategoryAttributeOptionManagementV1GetItemsGetWithHttpInfo($attribute_code)
    {
        // verify the required parameter 'attribute_code' is set
        if ($attribute_code === null) {
            throw new \InvalidArgumentException('Missing the required parameter $attribute_code when calling catalogCategoryAttributeOptionManagementV1GetItemsGet');
        }
        // parse inputs
