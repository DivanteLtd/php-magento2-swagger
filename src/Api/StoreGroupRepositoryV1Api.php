...
class StoreGroupRepositoryV1Api
{
     ...
     * @return \Swagger\Magento2Client\Model\StoreDataGroupInterface[]
     */
     ...
     *
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return array of \Swagger\Magento2Client\Model\StoreDataGroupInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function storeGroupRepositoryV1GetListGetWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Magento2Client\Model\StoreDataGroupInterface[]',
                '/V1/store/storeGroups'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Magento2Client\Model\StoreDataGroupInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Magento2Client\Model\StoreDataGroupInterface[]', $e->getResponseHeaders());
