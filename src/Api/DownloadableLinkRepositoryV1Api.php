...
class DownloadableLinkRepositoryV1Api
{
     ...
     * @param string $sku  (required)
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return array of \Swagger\Magento2Client\Model\DownloadableDataLinkInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function downloadableLinkRepositoryV1GetListGetWithHttpInfo($sku)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Magento2Client\Model\DownloadableDataLinkInterface[]',
                '/V1/products/{sku}/downloadable-links'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Magento2Client\Model\DownloadableDataLinkInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Magento2Client\Model\DownloadableDataLinkInterface[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Magento2Client\Model\ErrorResponse', $e->getResponseHeaders());
     ...
     *
     * @param string $sku  (required)
     * @param \Swagger\Magento2Client\Model\Body78 $body  (optional)
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return int
     */
     ...
     * @param \Swagger\Magento2Client\Model\Body79 $body  (optional)
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return int
     */
