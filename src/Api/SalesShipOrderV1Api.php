...
class SalesShipOrderV1Api
{
     ...
     * @param \Swagger\Magento2Client\Model\Body76 $body  (optional)
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return int
     */
    public function salesShipOrderV1ExecutePost($order_id, $body = null)
    {
        list($response) = $this->salesShipOrderV1ExecutePostWithHttpInfo($order_id, $body);
        return $response;
    }
     ...
     */
    public function salesShipOrderV1ExecutePostWithHttpInfo($order_id, $body = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $order_id when calling salesShipOrderV1ExecutePost');
        }
        // parse inputs
