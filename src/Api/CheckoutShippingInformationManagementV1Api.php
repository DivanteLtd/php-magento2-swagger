...
class CheckoutShippingInformationManagementV1Api
{
     ...
     *
     * @param \Swagger\Magento2Client\Model\Body84 $body  (optional)
     ...
     * @param \Swagger\Magento2Client\Model\Body85 $body  (optional)
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return \Swagger\Magento2Client\Model\CheckoutDataPaymentDetailsInterface
     */
    ...
    public function checkoutShippingInformationManagementV1SaveAddressInformationPost_0WithHttpInfo($cart_id, $body = null)
    {
        ...
        if ($cart_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $cart_id when calling checkoutShippingInformationManagementV1SaveAddressInformationPost_0');
        }
        // parse inputs
