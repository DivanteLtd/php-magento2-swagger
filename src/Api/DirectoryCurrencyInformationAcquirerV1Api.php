...
class DirectoryCurrencyInformationAcquirerV1Api
{
     ...
     * @return \Swagger\Magento2Client\Model\DirectoryDataCurrencyInformationInterface
     */
     ...
     *
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return array of \Swagger\Magento2Client\Model\DirectoryDataCurrencyInformationInterface, HTTP status code, HTTP response headers (array of strings)
     */
    public function directoryCurrencyInformationAcquirerV1GetCurrencyInfoGetWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Magento2Client\Model\DirectoryDataCurrencyInformationInterface',
                '/V1/directory/currency'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Magento2Client\Model\DirectoryDataCurrencyInformationInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Magento2Client\Model\DirectoryDataCurrencyInformationInterface', $e->getResponseHeaders());
