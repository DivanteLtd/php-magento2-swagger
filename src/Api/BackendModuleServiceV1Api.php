...
/**
 * BackendModuleServiceV1Api Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Magento2Client
 * @author   Swagger Codegen team
...
class BackendModuleServiceV1Api
{
     ...
     * @return string[]
     */
    public function backendModuleServiceV1GetModulesGet()
    {
        list($response) = $this->backendModuleServiceV1GetModulesGetWithHttpInfo();
        return $response;
    }

    /**
     * Operation backendModuleServiceV1GetModulesGetWithHttpInfo
     *
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return array of string[], HTTP status code, HTTP response headers (array of strings)
     */
    public function backendModuleServiceV1GetModulesGetWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/V1/modules";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
