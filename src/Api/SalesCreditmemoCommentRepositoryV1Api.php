...
class SalesCreditmemoCommentRepositoryV1Api
{
     ...
     * @param \Swagger\Magento2Client\Model\Body70 $body  (optional)
     ...
     * @param \Swagger\Magento2Client\Model\Body70 $body  (optional)
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return array of \Swagger\Magento2Client\Model\SalesDataCreditmemoCommentInterface, HTTP status code, HTTP response headers (array of strings)
     */
    public function salesCreditmemoCommentRepositoryV1SavePostWithHttpInfo($id, $body = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Magento2Client\Model\SalesDataCreditmemoCommentInterface',
                '/V1/creditmemo/{id}/comments'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Magento2Client\Model\SalesDataCreditmemoCommentInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Magento2Client\Model\SalesDataCreditmemoCommentInterface', $e->getResponseHeaders());
