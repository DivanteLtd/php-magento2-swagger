...
class CatalogProductAttributeRepositoryV1Api
{
     ...
     * @return bool
     */
    public function catalogProductAttributeRepositoryV1DeleteByIdDelete($attribute_code)
    {
        list($response) = $this->catalogProductAttributeRepositoryV1DeleteByIdDeleteWithHttpInfo($attribute_code);
        return $response;
    }
     ...
     */
    public function catalogProductAttributeRepositoryV1DeleteByIdDeleteWithHttpInfo($attribute_code)
    {
        // verify the required parameter 'attribute_code' is set
        if ($attribute_code === null) {
            throw new \InvalidArgumentException('Missing the required parameter $attribute_code when calling catalogProductAttributeRepositoryV1DeleteByIdDelete');
        }
        // parse inputs
     ...
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return \Swagger\Magento2Client\Model\CatalogDataProductAttributeSearchResultsInterface
     */
    public function catalogProductAttributeRepositoryV1GetListGet($search_criteria_filter_groups_filters_field = null, $search_criteria_filter_groups_filters_value = null, $search_criteria_filter_groups_filters_condition_type = null, $search_criteria_sort_orders_field = null, $search_criteria_sort_orders_direction = null, $search_criteria_page_size = null, $search_criteria_current_page = null)
    {
        list($response) = $this->catalogProductAttributeRepositoryV1GetListGetWithHttpInfo($search_criteria_filter_groups_filters_field, $search_criteria_filter_groups_filters_value, $search_criteria_filter_groups_filters_condition_type, $search_criteria_sort_orders_field, $search_criteria_sort_orders_direction, $search_criteria_page_size, $search_criteria_current_page);
        return $response;
    }
     ...
     * @param int $search_criteria_current_page Current page. (optional)
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return array of \Swagger\Magento2Client\Model\CatalogDataProductAttributeSearchResultsInterface, HTTP status code, HTTP response headers (array of strings)
     */
    public function catalogProductAttributeRepositoryV1GetListGetWithHttpInfo($search_criteria_filter_groups_filters_field = null, $search_criteria_filter_groups_filters_value = null, $search_criteria_filter_groups_filters_condition_type = null, $search_criteria_sort_orders_field = null, $search_criteria_sort_orders_direction = null, $search_criteria_page_size = null, $search_criteria_current_page = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Magento2Client\Model\CatalogDataProductAttributeSearchResultsInterface',
                '/V1/products/attributes'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Magento2Client\Model\CatalogDataProductAttributeSearchResultsInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Magento2Client\Model\CatalogDataProductAttributeSearchResultsInterface', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Magento2Client\Model\ErrorResponse', $e->getResponseHeaders());
     ...
     *
     * @param \Swagger\Magento2Client\Model\Body21 $body  (optional)
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return \Swagger\Magento2Client\Model\CatalogDataProductAttributeInterface
     */
     ...
     *
     * @param string $attribute_code  (required)
     * @param \Swagger\Magento2Client\Model\Body20 $body  (optional)
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return \Swagger\Magento2Client\Model\CatalogDataProductAttributeInterface
     */
    public function catalogProductAttributeRepositoryV1SavePut($attribute_code, $body = null)
    {
        list($response) = $this->catalogProductAttributeRepositoryV1SavePutWithHttpInfo($attribute_code, $body);
        return $response;
    }
     ...
     * @return array of \Swagger\Magento2Client\Model\CatalogDataProductAttributeInterface, HTTP status code, HTTP response headers (array of strings)
     */
    public function catalogProductAttributeRepositoryV1SavePutWithHttpInfo($attribute_code, $body = null)
    {
        // verify the required parameter 'attribute_code' is set
        if ($attribute_code === null) {
            throw new \InvalidArgumentException('Missing the required parameter $attribute_code when calling catalogProductAttributeRepositoryV1SavePut');
        }
        // parse inputs
        $resourcePath = "/V1/products/attributes/{attributeCode}";
        $httpBody = '';
