...
class CatalogCategoryManagementV1Api
{
     ...
     * @param int $depth  (optional)
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return array of \Swagger\Magento2Client\Model\CatalogDataCategoryTreeInterface, HTTP status code, HTTP response headers (array of strings)
     */
    public function catalogCategoryManagementV1GetTreeGetWithHttpInfo($root_category_id = null, $depth = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Magento2Client\Model\CatalogDataCategoryTreeInterface',
                '/V1/categories'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Magento2Client\Model\CatalogDataCategoryTreeInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Magento2Client\Model\CatalogDataCategoryTreeInterface', $e->getResponseHeaders());
     ...
     * @param \Swagger\Magento2Client\Model\Body32 $body  (optional)
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return bool
     */
