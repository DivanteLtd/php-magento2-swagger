...
/**
 * SalesInvoiceOrderV1Api Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Magento2Client
 * @author   Swagger Codegen team
...
class SalesInvoiceOrderV1Api
{
     ...
     * @param \Swagger\Magento2Client\Model\Body77 $body  (optional)
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return int
     */
    public function salesInvoiceOrderV1ExecutePost($order_id, $body = null)
    {
        list($response) = $this->salesInvoiceOrderV1ExecutePostWithHttpInfo($order_id, $body);
        return $response;
    }

    /**
     * Operation salesInvoiceOrderV1ExecutePostWithHttpInfo
     *
     * @param int $order_id  (required)
     * @param \Swagger\Magento2Client\Model\Body77 $body  (optional)
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     ...
     */
    public function salesInvoiceOrderV1ExecutePostWithHttpInfo($order_id, $body = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $order_id when calling salesInvoiceOrderV1ExecutePost');
        }
        // parse inputs
        $resourcePath = "/V1/order/{orderId}/invoice";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
