...
class SalesRuleCouponManagementV1Api
{
     ...
     *
     * @param \Swagger\Magento2Client\Model\Body105 $body  (optional)
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return \Swagger\Magento2Client\Model\SalesRuleDataCouponMassDeleteResultInterface
     */
     ...
     * @param \Swagger\Magento2Client\Model\Body105 $body  (optional)
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return array of \Swagger\Magento2Client\Model\SalesRuleDataCouponMassDeleteResultInterface, HTTP status code, HTTP response headers (array of strings)
     */
    public function salesRuleCouponManagementV1DeleteByCodesPostWithHttpInfo($body = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Magento2Client\Model\SalesRuleDataCouponMassDeleteResultInterface',
                '/V1/coupons/deleteByCodes'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Magento2Client\Model\SalesRuleDataCouponMassDeleteResultInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Magento2Client\Model\SalesRuleDataCouponMassDeleteResultInterface', $e->getResponseHeaders());
     ...
     *
     * @param \Swagger\Magento2Client\Model\Body104 $body  (optional)
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return \Swagger\Magento2Client\Model\SalesRuleDataCouponMassDeleteResultInterface
     */
     ...
     *
     * @param \Swagger\Magento2Client\Model\Body103 $body  (optional)
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return string[]
     */
