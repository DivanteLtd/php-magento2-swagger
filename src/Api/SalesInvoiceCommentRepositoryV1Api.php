...
/**
 * SalesInvoiceCommentRepositoryV1Api Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Magento2Client
 * @author   Swagger Codegen team
...
class SalesInvoiceCommentRepositoryV1Api
{
     ...
     *
     * @param \Swagger\Magento2Client\Model\Body68 $body  (optional)
    ...
    {
        list($response) = $this->salesInvoiceCommentRepositoryV1SavePostWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation salesInvoiceCommentRepositoryV1SavePostWithHttpInfo
     *
     * @param \Swagger\Magento2Client\Model\Body68 $body  (optional)
     * @throws \Swagger\Magento2Client\ApiException on non-2xx response
     * @return array of \Swagger\Magento2Client\Model\SalesDataInvoiceCommentInterface, HTTP status code, HTTP response headers (array of strings)
     */
    public function salesInvoiceCommentRepositoryV1SavePostWithHttpInfo($body = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Magento2Client\Model\SalesDataInvoiceCommentInterface',
                '/V1/invoices/comments'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Magento2Client\Model\SalesDataInvoiceCommentInterface', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Magento2Client\Model\SalesDataInvoiceCommentInterface', $e->getResponseHeaders());
