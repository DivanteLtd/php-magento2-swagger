...
class QuoteDataTotalSegmentExtensionInterface implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'tax_grandtotal_details' => '\Swagger\Magento2Client\Model\TaxDataGrandTotalDetailsInterface[]',
        'gift_cards' => 'string',
        'gw_order_id' => 'string',
        'gw_item_ids' => 'string[]',
    ...
    protected static $attributeMap = [
        ...
        'gw_order_id' => 'gwOrderId',
        'gw_item_ids' => 'gwItemIds',
     ...
     * @return \Swagger\Magento2Client\Model\TaxDataGrandTotalDetailsInterface[]
     */
     ...
     * @param \Swagger\Magento2Client\Model\TaxDataGrandTotalDetailsInterface[] $tax_grandtotal_details
     * @return $this
     */
