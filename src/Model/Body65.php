 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Body65 implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'status_history' => '\Swagger\Magento2Client\Model\SalesDataOrderStatusHistoryInterface'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['status_history'] === null) {
            $invalid_properties[] = "'status_history' can't be null";
        }
    ...
    /**
     * Sets status_history
     * @param \Swagger\Magento2Client\Model\SalesDataOrderStatusHistoryInterface $status_history
     * @return $this
     */
