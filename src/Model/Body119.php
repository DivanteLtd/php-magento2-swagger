 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Body119 implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'body_119';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['registry_id'] === null) {
            $invalid_properties[] = "'registry_id' can't be null";
        }
    ...
    /**
     * Sets registry_id
     * @param int $registry_id The estimate registry id
     * @return $this
     */
