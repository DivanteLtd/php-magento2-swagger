...
class Body16 implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'block' => '\Swagger\Magento2Client\Model\CmsDataBlockInterface'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['block'] === null) {
            $invalid_properties[] = "'block' can't be null";
        }
    ...
    /**
     * Sets block
     * @param \Swagger\Magento2Client\Model\CmsDataBlockInterface $block
     * @return $this
     */
