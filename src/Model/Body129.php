...
class Body129 implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'track' => '\Swagger\Magento2Client\Model\RmaDataTrackInterface'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['track'] === null) {
            $invalid_properties[] = "'track' can't be null";
        }
    ...
    /**
     * Sets track
     * @param \Swagger\Magento2Client\Model\RmaDataTrackInterface $track
     * @return $this
     */
