...
class Body21 implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'attribute' => '\Swagger\Magento2Client\Model\CatalogDataProductAttributeInterface'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['attribute'] === null) {
            $invalid_properties[] = "'attribute' can't be null";
        }
    ...
    /**
     * Sets attribute
     * @param \Swagger\Magento2Client\Model\CatalogDataProductAttributeInterface $attribute
     * @return $this
     */
